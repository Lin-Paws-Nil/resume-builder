...
try {
  ...
  if (!apiKey) {
    ...
    console.log('✅ OpenAI API key found for spelling fix (length:', apiKey.length, ')');
  }
  ...
  console.error('Failed to initialize OpenAI client for spelling fix:', error);
  throw error;
}
...
export async function POST(request: NextRequest) {
  try {
    ...
    // Log API call
    console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
    console.log('🚀 Calling OpenAI API for Spelling Fix...');
    console.log('Model: gpt-4o-mini');
    console.log('Text Length:', text.length, 'characters');
    console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');

    // Create prompt for spelling fix
    const prompt = `You are an expert proofreader. Fix all spelling errors in the following text. Return ONLY the corrected text with the same formatting (HTML tags, line breaks, etc.) preserved. Do not change grammar, only fix spelling mistakes.

Original text:
"${text}"

Return ONLY the corrected text with spelling fixed. Preserve all HTML formatting, line breaks, and structure. Do not add explanations, comments, or wrap the text in quotes. Return the text directly without any surrounding quotes or extra formatting.`;
    ...
    const completion = await openai.chat.completions.create({
      ...
      messages: [
        {
          role: 'system',
          content: 'You are an expert proofreader. Fix spelling errors only. Preserve all formatting, HTML tags, and structure. Return only the corrected text.',
        },
    ...
    console.log('✅ OpenAI API call successful for spelling fix');
    ...
    if (usage) {
      ...
      // Server-side logging
      console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
      console.log('📊 OpenAI API Usage & Cost (Spelling Fix)');
      console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
    ...
    console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
    console.log('✅ OpenAI API call completed (Spelling Fix)');
    console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
    ...
    return NextResponse.json(
      { error: error.message || 'Failed to fix spelling. Please try again.' },
      { status: 500 }
    );
  }
}
